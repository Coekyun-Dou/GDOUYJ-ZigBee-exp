...
/* SW_6 is at P0.1 */             //kkk SW_6 使用板载按键S1，IO口P0_4
#define HAL_KEY_SW_6_PORT   P0
//#define HAL_KEY_SW_6_BIT    BV(1)
#define HAL_KEY_SW_6_BIT    BV(4) //kkk
...
//kkk #define HAL_KEY_SW_6_ICTLBIT  BV(1) /* P0IEN - P0.1 enable/disable bit */
#define HAL_KEY_SW_6_ICTLBIT  BV(4) /* P0IEN - P0.4 enable/disable bit */
#define HAL_KEY_SW_6_PXIFG    P0IFG /* Interrupt flag at source */

/* Joy stick move at P2.0 */        //kkk 与LED D3的IO口冲突，暂且改为P2.2无视其功能
#define HAL_KEY_JOY_MOVE_PORT   P2
//#define HAL_KEY_JOY_MOVE_BIT    BV(0)
#define HAL_KEY_JOY_MOVE_BIT    BV(2) //kkk
...
#define HAL_KEY_JOY_MOVE_IENBIT   BV(2) /* Mask bit for all of Port_2 */
#define HAL_KEY_JOY_MOVE_ICTL     P2IEN /* Port Interrupt Control register */
//#define HAL_KEY_JOY_MOVE_ICTLBIT  BV(0) /* P2IENL - P2.0<->P2.3 enable/disable bit */
#define HAL_KEY_JOY_MOVE_ICTLBIT  BV(2) /*kkk P2IENL - P2.2 enable/disable bit */
