...
#define LED1_POLARITY     ACTIVE_LOW
  ...
  /* 3 - Yellow */
  #define LED3_BV          BV(3) //BV(4)
  #define LED3_SBIT        P1_3// P1_4
  #define LED3_DDR          P1DIR//P1DIR
...
#define PUSH1_BV          BV(1) //kkk
#define PUSH1_SBIT        P1_1  //kkk

#if defined (HAL_BOARD_CC2530EB_REV17)
  //#define PUSH1_POLARITY    ACTIVE_HIGH
  #define PUSH1_POLARITY    ACTIVE_LOW //kkk
#elif defined (HAL_BOARD_CC2530EB_REV13)
  //#define PUSH1_POLARITY    ACTIVE_LOW
  #define PUSH1_POLARITY    ACTIVE_HIGH //kkk
#else
  #error Unknown Board Indentifier
#endif
...
#define PUSH2_BV          BV(2) //kkk 与LED冲突，修改为P1_2
#define PUSH2_SBIT        P1_2  //kkk 与LED冲突，修改为P1_2
#define PUSH2_POLARITY    ACTIVE_LOW  //yt 与LED冲突，修改为P1_2
...
//#define HAL_PUSH_BUTTON2()        (PUSH2_POLARITY (PUSH2_SBIT)) //kkk 关闭按键功能
#define HAL_PUSH_BUTTON2()        (0) //kkk
...
/* ----------- LED's ---------- */
  ...
  #define HAL_TURN_OFF_LED3()       HAL_TURN_OFF_LED2()  //st( LED3_SBIT = LED3_POLARITY (0); )
  #define HAL_TURN_OFF_LED4()       HAL_TURN_OFF_LED1()

  #define HAL_TURN_ON_LED1()        st( LED1_SBIT = LED1_POLARITY (1); )
  #define HAL_TURN_ON_LED2()        st( LED2_SBIT = LED2_POLARITY (1); )
  #define HAL_TURN_ON_LED3()        HAL_TURN_ON_LED2()//st( LED3_SBIT = LED3_POLARITY (1); )
  #define HAL_TURN_ON_LED4()        HAL_TURN_ON_LED1()

  #define HAL_TOGGLE_LED1()         st( if (LED1_SBIT) { LED1_SBIT = 0; } else { LED1_SBIT = 1;} )
  #define HAL_TOGGLE_LED2()         st( if (LED2_SBIT) { LED2_SBIT = 0; } else { LED2_SBIT = 1;} )
  #define HAL_TOGGLE_LED3()         HAL_TOGGLE_LED2()//st( if (LED3_SBIT) { LED3_SBIT = 0; } else { LED3_SBIT = 1;} )
  #define HAL_TOGGLE_LED4()         HAL_TOGGLE_LED1()

  #define HAL_STATE_LED1()          (LED1_POLARITY (LED1_SBIT))
  #define HAL_STATE_LED2()          (LED2_POLARITY (LED2_SBIT))
  #define HAL_STATE_LED3()          HAL_STATE_LED2()//(LED3_POLARITY (LED3_SBIT))
...
#undef HAL_UART_DMA
//#define HAL_UART_DMA 1
#define HAL_UART_DMA 0      //串口功能使用ISR
