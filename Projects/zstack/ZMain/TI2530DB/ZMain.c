...
/********************************************************************/
void ParaProcess(void);//kkk
void ParaProcess(void)
{
  //read zgDefaultChannelList,zgConfigPANID from NV   
  osal_nv_read( ZCD_NV_CHANLIST, 0, 4, &zgDefaultChannelList);  
  if( (zgDefaultChannelList!=DEFAULT_CHANLIST11)&&(zgDefaultChannelList!=DEFAULT_CHANLIST12)&&(zgDefaultChannelList!=DEFAULT_CHANLIST13)&&(zgDefaultChannelList!=DEFAULT_CHANLIST14)
    &&(zgDefaultChannelList!=DEFAULT_CHANLIST15)&&(zgDefaultChannelList!=DEFAULT_CHANLIST16)&&(zgDefaultChannelList!=DEFAULT_CHANLIST17)&&(zgDefaultChannelList!=DEFAULT_CHANLIST18)
    &&(zgDefaultChannelList!=DEFAULT_CHANLIST19)&&(zgDefaultChannelList!=DEFAULT_CHANLIST20)&&(zgDefaultChannelList!=DEFAULT_CHANLIST21)&&(zgDefaultChannelList!=DEFAULT_CHANLIST22)
    &&(zgDefaultChannelList!=DEFAULT_CHANLIST23)&&(zgDefaultChannelList!=DEFAULT_CHANLIST24)&&(zgDefaultChannelList!=DEFAULT_CHANLIST25)&&(zgDefaultChannelList!=DEFAULT_CHANLIST26))
      zgDefaultChannelList=DEFAULT_CHANLIST11;
  
  osal_nv_read( ZCD_NV_PANID, 0, 2, &zgConfigPANID);
  if(zgConfigPANID == 0xffff)
    zgConfigPANID = 0x0101;
  
  osal_nv_read(ZCD_NV_NODEID, 0, 2, &zgDeviceNodeId);
  if(zgDeviceNodeId == 0xffff)
    zgDeviceNodeId = 0x0001;
}
...
int main(void)
{
  ...
  // Display information about tdevicehis device
  zmain_dev_info();
